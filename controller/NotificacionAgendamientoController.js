...
export function formatearFechaCita(fecha) {
  ...
  const fechaCalendario = new Date(Date.UTC(Number(anio), Number(mes) - 1, Number(dia)));

  return fechaCalendario.toLocaleDateString("es-CL", {
    weekday: "long",
    year: "numeric",
    month: "long",
    day: "numeric",
          ...
          return res.send(`
            ...
            <body>
              <div class="container">
                ...
                <p>Tu cita para el <strong>${formatearFechaCita(fechaInicio)}</strong> a las <strong>${horaInicio}</strong> ha sido confirmada exitosamente.</p>
          ...
          return res.send(`
            ...
            <body>
              <div class="container">
                ...
                <p><strong>${nombrePaciente} ${apellidoPaciente}</strong></p>
                <p>Tu cita para el <strong>${formatearFechaCita(fechaInicio)}</strong> a las <strong>${horaInicio}</strong> ha sido cancelada.</p>
